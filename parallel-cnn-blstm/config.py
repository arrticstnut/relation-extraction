...
tf.app.flags.DEFINE_string("model_type", "Model_parallel-blstm-cnn", "model file")
...
tf.app.flags.DEFINE_integer("num_filters_cnn",500,
                            "How many features a convolution op have to output")
tf.app.flags.DEFINE_integer("num_filters_lstm",1000,
                            "How many features a convolution op have to output")
...
tf.app.flags.DEFINE_integer("pos_embedding_size",20,"position embedding size")
